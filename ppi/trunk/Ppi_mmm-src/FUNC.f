...
C
    ...
    6       FORMAT(////A8/A7,A1/F8.0/F8.0/F8.0)
     ...
     X            NIN1(1:4).EQ.'MARK')THEN
            READ(TFUN,7)NIN2,MARK(1),MARK(2),NSCTP
    7       FORMAT(////A8/A8//A8//A8)
            DO I=1,IMRK
...
C     
 150     NGRD=NIN2(1:3)
c         write(6,1771)ngrd,nsctp,c1,c2,c3,c4
c 1771    format('  lobes: ',A3,A8,4f8.3)
...
C     
 770     NGRD=NIN2(1:3)
         do k=1,krad
            write(6,1772)ngrd,mark(k),xrad(k),yrad(k)
 1772       format('  uvdstd: ',A3,2X,A8,2f8.3)
         end do
