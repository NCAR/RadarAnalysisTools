...
C
      ...
      data lat_ll,lon_ll/47.0,5.0/
      data lat_lr,lon_lr/47.0,9.0/
      data lat_ul,lon_ul/50.0,5.0/
      data lat_ur,lon_ur/50.0,9.0/
...
c     
      do j=my_lat,1,-1
         latitude=lat_ul-float(j-1)*lat_del
...
c     
      ...
      DO 100 J=1,MXY
         ...
         DO 90 I=1,MXX
            ...
            VEX(I,J)=BDVAL
            ZGRND=BDVAL
c            CALL XY2LLDRV(PLAT_OUT,PLON_OUT,XP,YP,ORLAT,
c     X           ORLON,ANGXAX)
            CALL XY2LL(PLAT_OUT,PLON_OUT,XP,YP,ORLAT,
     X           ORLON,ANGXAX)
