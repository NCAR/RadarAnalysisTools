...
C
    ...
    5 CONTINUE
      print *,'FUNCTS: Before goto branch:  is=',is
...
c      CALL USTOPO(VEX,NI,NJ,I1,I2,J1,J2,CSP,LATLON,REFLAT,REFLON,
c     X     ANGXAX,ZIP)
      print *,'CALL RVTOPO,is=',is 
c      if(icall.gt.0)return
      CALL RVTOPO(VEX,NI,NJ,I1,I2,J1,J2,CSP,LATLON,REFLAT,REFLON,
     X     ANGXAX,ZIP)
      icall=icall+1
      print *,'AFTER CALL RVTOPO, icall,is=',icall,is
      is=0
      RETURN
