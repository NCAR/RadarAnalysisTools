...
extern int STRparse(char *inpstr, char **outstr,int nchars, int max_tokens, 
...
extern int STRparse_double(char *inpstr, double *outfields, int maxchr, int max_fields);
/* 
