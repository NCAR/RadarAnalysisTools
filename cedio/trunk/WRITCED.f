      SUBROUTINE WRITCED(SCINAME,SUBNAME,BASANG,VOLNAM,IBEGYR,
...
C     
C     SCINAME: SCIENTIST NAME (6 CHAR STRING)
C     SUBNAME: SUBMITTER NAME (6 CHAR STRING
...
C
      ...
      CALL HEADBLD(SCINAME,SUBNAME,BASANG,VOLNAM,IBEGYR,
     X     IBEGMNT,IBEGDAY,IBEGHR,IBEGMIN,IBEGSEC,IENDYR,
     X     IENDMNT,IENDDAY,IENDHR,IENDMIN,IENDSEC,XMIN,
     X     XMAX,NUMX,ISPCX,YMIN,YMAX,NUMY,ISPCY,ZMIN,
     X     ZMAX,NUMZ,ISPCZ,NFLD,FLDNAM,ISCLFLD,NUMLND,
