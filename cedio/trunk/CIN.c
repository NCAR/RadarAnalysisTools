...
void cinhead(INUNIT,NUM1,NUM2,IBUF,IREW,MBYTE,FBYTE,NST)
#elif defined (CRAY)
void CINHEAD(INUNIT,NUM1,NUM2,IBUF,IREW,MBYTE,FBYTE,NST)
#else
void cinhead_(INUNIT,NUM1,NUM2,IBUF,IREW,MBYTE,FBYTE,NST)
#endif
     int *INUNIT, *NUM1, *NUM2, *IREW, *MBYTE, *FBYTE, *NST;
     int IBUF[510];
{
  int i = 0, iloc = 0;
  FILE *fp;
